...
public class ApiService {
    ...
    private String getAccessToken() {
        ...
        try {
            ...
            System.out.println("✅ Cisco token generated, valid for " + expiresIn + " seconds.");
            return accessToken;
        } catch (Exception e) {
        ...
        for (JsonNode adv : advisories) {
            try {
                ...
                for (String cveId : cveIds) {
                    boolean exists = advisoryRepository.existsById(cveId);
                    if (!exists) added++;
...
public class ApiService {
    ...
    private String getAccessToken() {
        ...
        try {
            ...
            System.out.println("🔑 Cisco token obtained. Expires in " + expiresIn + "s.");
            return accessToken;
